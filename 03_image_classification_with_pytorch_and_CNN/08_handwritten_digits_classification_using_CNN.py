...
print(X_train.shape)
print(y_train)
# We need to create a 4 dimensional tensor to be passed into the model, so it will be something like 1,1,28,28.
...
# input Image ---> conv1 -->Relu ---> pooling ---> conv2-->Relu --> fc1--> relu --> fc2--> relu --fc3 --> softmax --> output
